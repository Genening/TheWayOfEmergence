---
title: "Chapter 14: The Relativity of Hierarchies"
---

# Chapter 14: The Relativity of Hierarchies
...
Each layer is the emergence of the layer below, while providing elements for the layer above.
...
For sociologists: Individuals are basic elements (cells are too microscopic)
```

There is no absolute "basic," only "basic relative to the research question."
...
```
Physical laws ≠ Chemical laws ≠ Biological rules ≠ Psychological rules ≠ Social rules
```

Although higher-level laws are compatible with lower-level laws, higher-level laws have their own independent validity.
...
1. The universe exhibits a multi-level nested structure
2. "Elements," "laws," and "emergence" are all relative to the level
3. Reductionism is valuable but limited; complete reduction is usually infeasible
4. Downward causation is real and can be understood as boundary condition constraints
5. Different sciences study different levels; complexity science studies cross-level patterns
6. Choosing the right level of analysis is key to effective research and intervention

---

## Questions for Reflection

1. Why can we say "chemistry can be reduced to physics" while also saying "chemistry has its own laws"? Is this contradictory?

2. What's wrong with the statement "consciousness is just neurons firing"? Analyze from the hierarchy perspective.

3. If everything is ultimately determined by physical laws, does "free will" still have meaning? How does the hierarchy perspective help us think about this?

4. Choose a problem you care about. List which different levels it can be analyzed from, and what insights each level provides.
